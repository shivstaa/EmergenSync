...
function ERDetail({ roomsAvailable, roomsUnavailable }) {
    return (
        <div className="bg-gray-800 h-[calc(100vh-84px)] flex flex-col px-5 py-2">
            <div className="mb-12">
                <h1 className="text-2xl text-white mb-4 font-bold">San Francisco Hospital</h1>
                <div className="text-gray-200 space-y-4">
                    <div className="text-xl">
                        Rooms Available: <span className="text-green-500 font-bold">{roomsAvailable}</span>
                    </div>
                    ...
                    <hr className="border-white" />
                    <div className="text-xl">
                        Rooms Closed: <span className="text-red-500 font-bold">{roomsUnavailable}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="text-white overflow-y-scroll custom-scrollbar">
                ...
                <div className="border-2 border-white px-4 py-2 mb-2">
                    ...
                    <p className="text-sm text-gray-400">Last Updated: 2023-10-28 14:30:00</p>
                </div>
                ...
                <div className="border-2 border-white px-4 py-2 mb-2">
                    ...
                    <p className="text-sm text-gray-400">Last Updated: 2023-10-28 15:45:00</p>
                </div>
