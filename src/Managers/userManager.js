...
export class UserManager {
  ...
  // }
    ...
    async createUser(uuid, userType, emailAddress){
        const userRef = doc(db, "Users", uuid); // Use doc to reference a specific document
        try {
            await setDoc(userRef, {userType, emailAddress}); // Use setDoc to set the document data
