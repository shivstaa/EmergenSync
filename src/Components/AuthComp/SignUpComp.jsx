...
function SignUpComp() {
  ...
  return (
    <div className={"flex justify-center items-center h-[calc(100vh-84px)]"}>
      <div
        className={"bg-white p-5 w-full max-w-md border rounded-md space-y-7"}
      >
        <div>
        ...
        <button
          ...
          className="flex items-center justify-center w-full text-blue-500 border py-2 px-4 rounded"
        >
          <img
          ...
          <div className="flex items-center justify-around border rounded py-2">
            <div className="flex items-center">
              <input
                ...
                required
              />
              <label htmlFor="paramedic" className="ml-2">
                Paramedic
              </label>
            </div>
        ...
        <h1 className={"text-center"}>
          ...
          <Link
            to={"/login"}
            className={
              "font-bold hover:text-blue-700 hover:cursor-pointer hover:underline"
            }
          >
            Login
          </Link>
